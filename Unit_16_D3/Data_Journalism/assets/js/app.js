...
d3.csv("/assets/data/data.csv", function(err, journalData) {
  ...
  journalData.forEach(function(data) {
    data.poverty = +data.poverty; //X hair_length
    data.age = +data.age; // X num_albums
    data.obesity = +data.obesity; // X num_albums
    data.healthcare = +data.healthcare; // Y num_hits
    data.abbr = +data.abbr;
  });
  ...
  var ageLabel = labelsGroup.append("text")
    ...
    .classed("inactive", true)
    .text("Average of Obesity people");
  ...
  chartGroup.append("text")
    ...
    .text("Number of people with healthcare (000)");
